...
int main()
{
    ...
    while(1)
    {
        ...
        printf("\n3. Checkout Room");
        printf("\n4. Generate Bill");
        printf("\n5. Update Booking (Add one more room)");
        printf("\n6. Exit");
        printf("\nEnter choice: ");
        scanf("%d",&choice);
        ...
        switch(choice)
        {
            ...
            case 2:
                ...
                if(hotel[floor][room].status == 0)
                {
                    ...
                    hotel[floor][room].roomsBooked = 1;
            ...
            case 5:
                ...
                {
                    hotel[floor][room].roomsBooked++;
                    printf("One more room added to booking!");
                }
                else
